      ...
      <div className="projects">
        <div className="project stay-lucid">
          <div className="project-intro">
            ...
            <p>
              A lucid dream assistant site with a social media aspect named the
              Dream Forum. The user is given the ability to create dreams and
              upload them to the dream forum if they choose. The user can also
              add 'tags' to their dream so they can easily differentiate between
              each dream. In the Dream Forum, other users can like posts that
              are accumulated and updated on the posters' profile page. On that
              profile page, the user can change their username and profile
              picture.
            </p>
          </div>
        ...
        <div className="project thedeck">
          <div className="project-intro">
            ...
            <p>
              ...
              Realtime Databases to help them study using flashcards. This was a
              solo project where I did the design, sourced color palette, and
              coding. This site requires an account to create 'Decks' of
        ...
        <div className="project shuffle">
          <div className="project-intro">
            ...
            <p>
              ...
              prompts the user to sign in and receive an access token to access
              the API. When the user clicks on one of their playlists, it will
              display a Shuffle, Confirm, and Cancel button along with all the
              songs in a list view. They can Shuffle until satisfied with the
              random order and then click Confirm to translate those changes to
              Spotify using their API, promoting a seamless and quick
              rearranging of their playlists.
            </p>
          </div>
          <div className="project-details">
            <h3>Technology Used</h3>
            ...
            <ul>
              ...
              <li>
                I learned how to use the Spotify API which gave me a ton of data
              </li>
