    ...
    >
      ...
      <div className="projects">
        <div className="project thedeck">
          ...
          {/* <button className="expand-btn" onClick={() => toggleExpand("thedeck")}><i class="fa-solid fa-angle-down"></i></button> */}
        </div>
        ...
        <div className="project bgmcguire">
          ...
          {/* <button className="expand-btn" onClick={() => toggleExpand("bgmcguire")}><i class="fa-solid fa-angle-down"></i></button> */}
        </div>
        ...
        <div className="project randomorg">
          <div className="project-intro">
            ...
            <p className="">
              A clone of the site, random.org. I made this because I use the
              original site to shuffle my spotify playlist but because the real
              sites' features are out of the scope, I only added the ones I use
              most or use the most. I made it a single page app because I wanted
              it to be fast and I love using React!
            </p>
          </div>
          <div className="project-details ">
            <h3>Technology Used</h3>
            ...
            <ul>
              ...
              <li>
                It was way more responsive and produced mass lists much faster
              </li>
          ...
          <div className="project-buttons">
            <a
              href="https://github.com/SWELLZ/randomorg-clone"
              target="_blank"
              rel="noreferrer"
            >
              <i class="fa-brands fa-github"></i>
            ...
            <a
              href="https://randomorg-clone.netlify.app/"
              target="_blank"
              rel="noreferrer"
            >
              <i class="fa-solid fa-arrow-up-right-from-square"></i>
          ...
          {/* <button className="expand-btn" onClick={() => toggleExpand("randomorg")}><i class="fa-solid fa-angle-down"></i></button> */}
        </div>
        ...
        <div className="project cmluxury">
          <div className="project-intro">
            ...
            <p className="">
              A static single page site I created for my girlfriend's new career
              of cosmetology. I made it to keep her motivated so as of now,
              there is no functionality but it is still mobile friendly and
              styled to her aesthetic.
            </p>
          </div>
          <div className="project-details ">
            <h3>Technology Used</h3>
            ...
            <ul>
              <li>
                It was one of my first sites so it taught me a lot about design
              </li>
          ...
          {/* <button className="expand-btn" onClick={() => toggleExpand("cmluxury")}><i class="fa-solid fa-angle-down"></i></button> */}
        </div>
        ...
        <div className="project quote-generator">
          <div className="project-intro">
            ...
            <p className="">
              A simple single page site that produces a new quote along with the
              author every time you click 'New Quote'. The site also has the
              functionality to automatically post the quote and author in text
              format to Twitter or Tumblr by clicking the logo.
            </p>
          </div>
          <div className="project-details ">
            <h3>Technology Used</h3>
          ...
          {/* <button className="expand-btn" onClick={() => toggleExpand("quote-generator")}><i class="fa-solid fa-angle-down"></i></button> */}
        </div>
        ...
        <div className="project promo-code">
          <div className="project-intro">
            ...
            <p className="">
              A command line project with the purpose of generating a Promo Code
              and emailing it to a customers' email automatically. I made this
              for a business that I started years ago in order to promote
              organic growth.
            </p>
          </div>
          <div className="project-details ">
          ...
          <div className="project-buttons">
            <a
              href="https://youtu.be/AhK9sPZQXcU"
              target="_blank"
              rel="noreferrer"
            >
              <i class="fa-solid fa-arrow-up-right-from-square"></i>
          ...
          {/* <button className="expand-btn" onClick={() => toggleExpand("promo-code")}><i class="fa-solid fa-angle-down"></i></button> */}
        </div>
      </div>
    </section>
  );
